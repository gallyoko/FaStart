...
public class WidgetTypeRepository {
    ...
    public ArrayList<WidgetTypeEntity> getAll(){
        Cursor c = bdd.query(TABLE_NAME, new String[] {COL_ID, COL_NAME}, null, null, null, null, null);
        return cursorToWidgetTypeEntityArrayList(c);
    }

    public WidgetTypeEntity getByName(String name){
        Cursor c = bdd.query(TABLE_NAME, new String[] {COL_ID, COL_NAME}, COL_NAME + " LIKE \"" + name +"\"", null, null, null, null);
        return cursorToWidgetTypeEntity(c);
    }

    public WidgetTypeEntity getById(int id){
        Cursor c = bdd.query(TABLE_NAME, new String[] {COL_ID, COL_NAME}, COL_ID + " = \"" + id +"\"", null, null, null, null);
        return cursorToWidgetTypeEntity(c);
    }
